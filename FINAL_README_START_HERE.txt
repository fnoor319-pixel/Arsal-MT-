V11.1.0 CURRENT BUILD: READ V11_1_UPGRADE_README.txt FIRST
================================================
Start: 00_RUN_ME_DEMO.bat. Status: 47_V11_CANONICAL_STATUS.bat.
Configured Luna is an async final candidate reviewer; failures use local fallback.
Use the code-only update to keep learning accumulated after the upload.
The older pipeline below is retained for reference and is superseded by V11.
No profit or win-rate promise. DEMO only.
